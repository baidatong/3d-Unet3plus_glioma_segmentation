...
def unet3d(inputs):
    ...
    decode3_3 = UnetUpsample(prefix='upsample3_3', l=decode2, num_filters=BASE_FILTER4,scale=2)
    ...
    decode4_2  = UnetUpsample(prefix='decode4_2', l = decode1, num_filters=BASE_FILTER4,scale=8)
    ...
    upsample4_3 = UnetUpsample(prefix='upsample4_3', l=decode2, num_filters=BASE_FILTER4,scale=4)
    ...
    decode4_4 = UnetUpsample(prefix='upsample4_4', l=decode3, num_filters=BASE_FILTER4,scale=2)
